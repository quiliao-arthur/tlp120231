...
SELECT DISTINCT curso.nome AS Cursos_de_Mais_de_20_Horas_da_Instituição_Mundodosdoces_e_com_Aluno_com_Especialidade_em_Bolos 
FROM curso 
...
FROM ingrediente 
 INNER JOIN doceingrediente ON ingrediente.id = doceingrediente.idingrediente 
...
-- g) Apresente o nome e a modalidade (especialidade) dos confeiteiros que fizeram algum curso com o nome "Bolos para casamento" com duração de 30 horas e que estão vinculados a algum doce.
